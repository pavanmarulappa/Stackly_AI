...
export default function Header() {
  ...
  const topBarVariants = {
    open: { rotate: 45, y: 7, backgroundColor: "#007B82" },
    closed: { rotate: 0, y: 0, backgroundColor: "#374151" }
  };
    ...
    <div>
      ...
      >
          ...
          <motion.img
            ...
            animate={{
              filter: isHoveringLogo
                ? "drop-shadow(0 0 8px rgba(0, 123, 130, 0.6))"
                : "none"
            }}
          />
        </motion.div>
                ...
                >
                  <NavLink
                    ...
                    className={({ isActive }) =>
                      ...
                      w-[124px] h-[46px] px-[8px] py-[12px] rounded-[40px] transition-all duration-200 
                      ${isActive
                        ? "text-white bg-[#007B82] shadow-lg shadow-[#007B82]/50"
                        : "text-[#007B82] hover:shadow-md hover:shadow-[#007B82]/30"
                      }`
                    }
                  >
                    {label}
        ...
        <div className="flex items-center justify-center z-10 relative gap-5">
          {userInfo.userId ? (
            <motion.div
      className="z-10 relative inline-flex items-center justify-center gap-1 cursor-pointer"
      whileHover={{ scale: 1.05 }}
  ...
  >
    ...
    >
      ...
      >
        <path
          d="M6.51543 1.86233L1.49227 6.88548C1.32142 7.05634 1.12209 7.13903 0.894278 7.13357C0.666471 7.1281 0.467138 7.03971 0.296283 6.8684C0.125427 6.69709 0.0399991 6.49776 0.0399991 6.2704C0.0399991 6.04305 0.125427 5.84372 0.296283 5.67241L5.54155 0.410054C5.67824 0.273369 5.83201 0.170856 6.00286 0.102514C6.17372 0.0341712 6.34458 0 6.51543 0C6.68629 0 6.85714 0.0341712 7.028 0.102514C7.19885 0.170856 7.35262 0.273369 7.48931 0.410054L12.7517 5.67241C12.9225 5.84327 13.0052 6.04556 12.9997 6.27929C12.9943 6.51302 12.9059 6.71508 12.7346 6.88548C12.5633 7.05588 12.3639 7.14131 12.1366 7.14177C11.9092 7.14222 11.7099 7.0568 11.5386 6.88548L6.51543 1.86233Z"
          fill="#007B82"
        />
      </motion.svg>
      ...
      <AnimatePresence>
        {isHovered && (
          <motion.div
            className="profile-list min-w-[150px] p-4 z-20 flex flex-col gap-2 absolute top-full right-0 mt-2 bg-white rounded-md shadow-xl"
          ...
          >
            ...
            >
              <NavLink
                to="/Profile"
                className="text-[#2a2a2a] hover:text-[#007B82] transition-colors"
              >
                My Profile
              </NavLink>
            </motion.div>
            ...
            <motion.div
              className="w-[265px] h-[42px] min-[900px]:flex hidden gap-[24px]"
              initial={{ opacity: 0, y: 10 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              ...
              >
                <NavLink
                  to="/sign-in"
                  className={({ isActive }) =>
                    `w-[113px] h-[42px] text-[18px] font-semibold leading-[100%] border-[1px] cursor-pointer 
         flex justify-center items-center no-underline rounded-[8px] border-solid transition-all duration-300
         hover:shadow-[0_0_8px_#007B82AA] hover:bg-[#e6f7f8]
         ${isActive
                      ? "bg-[#007b82] text-white border-[#007b82]"
        ...
        >
          <motion.div
            className="w-full h-1 rounded-md mx-0 my-[5px]"
      ...
      <AnimatePresence>
        {showSideBar && (
          <motion.section
            className="fixed top-0 transition-all w-[70vw] sm:w-[50%] bg-white shadow-2xl min-h-[120vh] flex flex-col min-[900px]:hidden gap-7 justify-start items-start p-[40px] z-50"
            style={{ listStyle: "none" }}
          ...
          >
            ...
            {!userInfo.userId && (
              ...
              >
                <motion.button
                  className="w-[107px] h-[39px] text-[20px] font-semibold leading-[100%] border bg-white text-[#007b82] cursor-pointer flex justify-center items-center no-underline rounded-[5px] border-solid border-[#007b82]"
                  onClick={() => {
                    navigate("/sign-in");
                    setShowSideBar(false);
                  }}
                ...
                <motion.button
                  className="w-[107px] h-[39px] text-[20px] font-semibold leading-[100%] border bg-[#007b82] text-white cursor-pointer flex justify-center items-center no-underline rounded-[5px] border-solid border-white"
                  onClick={() => {
                    navigate("/sign-up");
                    setShowSideBar(false);
                  }}
