...
{window.innerWidth < 769 && (
  ...
  >
      ...
      />
        ...
        <div className="w-full max-[1440px]:p-5 max-[1000px]:flex-col max-[1000px]:gap-[40px] min-h-screen bg-[#000000b2] flex items-center justify-center gap-5 px-[5%] py-[25px]">

         <div
  className="
    mt-[80px] min-[770px]:mr-[105px] max-[440px]:mt-[80px] sm:mt-0 
...
>
  Get started with 10 free outputs – No credit card needed!
         ...
         <div
  className="
    max-[1440px]:w-full min-[770px]:mr-[105px] flex-1 max-w-[522px] min-h-[618px] border flex flex-col items-center justify-center bg-[#00000033] pt-[28px] pr-[32px] pb-[28px] pl-[32px] rounded-[10px] border-solid border-white gap-[40px] shadow-[0_1px_3px_0]
