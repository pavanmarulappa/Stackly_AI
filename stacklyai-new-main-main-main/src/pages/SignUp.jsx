...
{window.innerWidth < 769 && (
  ...
  className="
    ...
    xl:flex-none xl:w-[469px] xl:h-[455px] xl:justify-between xl:opacity-100

    /* Tablet styles */
    min-[441px]:max-[768px]:w-[608px]
    min-[441px]:max-[768px]:h-[612px]
...
>
  ...
  className="
    ...
    min-[441px]:max-[768px]:shadow-none
      min-[441px]:max-[768px]:pt-[-98px]
      min-[441px]:max-[768px]:pb-[165px]
  "
>
