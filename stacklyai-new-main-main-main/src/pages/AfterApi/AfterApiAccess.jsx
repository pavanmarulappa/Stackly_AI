...
const AfterApiAccess = () => {
  return (
    <div className="w-full flex justify-center items-center px-4 py-6 bg-white ">
      <div className=" w-full max-w-[1280px] min-h-[700px] rounded-[30px] border border-[#FCFCFC] px-6 py-12 bg-[#FCFCFC] shadow-[0_0_4px_0] shadow-[#00000040] relative">
        {/* Heading */}
