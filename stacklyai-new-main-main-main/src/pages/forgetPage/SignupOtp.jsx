...
const SignupOtp = () => {
  ...
  return (
    ...
    >
      <div
        className={`
          relative w-[740px] h-[480px] rounded-[16px] border-2 
      ...
      >
        ...
        {/* Title */}
        <h2 className="text-white text-[28px] font-normal leading-[100%] text-center font-[Poppins]">
          Enter OTP
        </h2>

        {/* Subtext */}
        <p className="text-[#F7F7FF80] text-[16px] text-center max-w-[420px] mt-1">
