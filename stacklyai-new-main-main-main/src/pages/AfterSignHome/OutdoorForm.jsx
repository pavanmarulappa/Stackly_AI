...
export default function OutdoorForm() {
  ...
  const roomTypes = {
    Interiors: ["Front Yard", "Backyard", "Balcony", "Terrace/ Rooftop", "Driveway / Parking Area", "Walkway / Path",  "lounge", "Porch", "Fence", "Garden",],
    Exteriors: [
      "Front Yard",
      "Backyard",
      "Garden",
  ...
  const styles = [
    "Modern", "Contemporary", "Traditional", "Rustic", "Scandinavian", "Classic Garden", "Coastal Outdoor",  "Farmhouse", "Cottage Garden",  "Industrial", "Beach",
  ];
  const changeImage = (e) => {
    // if (!userInfo.userId) {
        ...
        <div className="w-full max-w-7xl flex flex-col xl:flex-row gap-10 items-start justify-between">
          ...
          >
            ...
            {[
              ...
              { label: "Pick a Style", name: "Design Style", options: styles },
              {
