...
import Interiors from "../AfterSignHome/FormAfter";
import Exteriors from "../AfterSignHome/ExteriorForm";
import Outdoors from "../AfterSignHome/OutdoorForm";
...
export default function ExteriorForm() {
  ...
  const roomTypes = {
    Interiors: ["Front Side", "Back Side", "Left Side", "Right Side"],
    Exteriors: [
      "Front Yard",
      "Backyard",
      "Garden",
