...
export default function SignIn() {
  ...
  return (
    <div>
      ...
      >
        ...
        <div className="absolute top-[35px] left-[24px] bg-white p-[2px] rounded-[3px] hidden max-[440px]:block">
          <img
            src={logoImg}
            alt="logo"
  ...
  max-[440px]:text-center max-[440px]:w-[360px] max-[440px]:h-[17px]">
            ...
            >
              <input
                className="w-[456px] max-w-[465px] min-h-[44px] bg-[white] p-[15px] placeholder:text-base placeholder:font-normal placeholder:text-[#2a2a2a] rounded-[8px]
    max-[440px]:w-[360px] max-[440px]:h-[44px] max-[440px]:rounded-[8px]"
              ...
              {/* Password Field */}
              <div className="relative w-[456px] max-w-[465px] max-[440px]:w-[360px]">
                <input
                  type={showPassword ? "text" : "password"}
                  placeholder="Password"
                  required
                  ...
                  className="w-full min-h-[44px] bg-white p-[15px] pr-[45px] 
      placeholder:text-base placeholder:font-normal placeholder:text-[#2a2a2a]
      rounded-[8px] border border-[#e0e0e0] focus:border-[#009A98] focus:outline-none
      text-[#2a2a2a] text-base font-normal
      max-[440px]:w-full max-[440px]:h-[44px] max-[440px]:rounded-[8px]"
                />
