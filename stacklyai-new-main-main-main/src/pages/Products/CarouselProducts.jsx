...
//   return (
//    <div className="w-full h-[804px] bg-[#001e20] p-[20px] sm:p-[50px] mt-10 max-[440px]:flex max-[440px]:flex-col max-[440px]:w-[440px] max-[440px]:min-h-[468px] max-[440px]:py-[40px] max-[440px]:px-[20px] max-[440px]:gap-[32px]">
//       {/* Original h3 - hidden below 441px */}
// <h3 className="hidden min-[441px]:block text-2xl sm:text-[40px] text-white font-bold text-center">
//   Latest <span className="text-[#00b0ba]">Design Trends</span>
// </h3>
...
//   {/* Image Slider */}
//   <div className="h-[400px] flex-1 max-w-[850px] aspect-video overflow-hidden w-fit flex flex-nowrap gap-0 items-center justify-start rounded-[15px]">
//     <div
//       className="min-w-full transition-all"
//       style={{ transform: `translateX(${index * -100}%)` }}
//     >
...
// {/* Indicators */}
// <div className="flex justify-center items-center mt-10 gap-[14px] my-5">
//   <span
//     onClick={() => setIndex(0)}
//     className={`w-[12px] h-[12px] rounded-full cursor-pointer transition-all duration-200 ${
//       index === 0 ? "bg-[#00B0BA]" : "bg-white border border-[#D0D0D0]"
//     }`}
//   />
//   <span
//     onClick={() => setIndex(1)}
//     className={`w-[12px] h-[12px] rounded-full cursor-pointer transition-all duration-200 ${
//       index === 1 ? "bg-[#00B0BA]" : "bg-white border border-[#D0D0D0]"
//     }`}
//   />
//   <span
//     onClick={() => setIndex(2)}
//     className={`w-[12px] h-[12px] rounded-full cursor-pointer transition-all duration-200 ${
//       index === 2 ? "bg-[#00B0BA]" : "bg-white border border-[#D0D0D0]"
//     }`}
//   />
// </div>
...
export default function CarouselProducts() {
  ...
  return (
    <div className="w-full bg-[#001e20] p-[20px] sm:p-[50px] mt-10 max-[440px]:flex max-[440px]:flex-col max-[440px]:w-[440px] max-[440px]:min-h-[468px] max-[440px]:py-[40px] max-[440px]:px-[20px] max-[440px]:gap-[32px]">
      ...
      <div className="w-full text-center font-[400] text-[24px] leading-[28px] text-white my-[22px]">
        <p className="hidden min-[441px]:block">
          Curated ideas for modern living
        </p>
        <p className="hidden max-[440px]:flex w-[400px] h-[21px] font-inter font-normal text-center items-center justify-center text-white text-[14px] leading-[28px] tracking-[0%] mt-[-30px]">
          Curated ideas for modern living
      ...
      <div className="overflow-x-hidden flex gap-2 sm:gap-5 w-full mt-10 px-2 items-center justify-center max-[440px]:flex-col max-[440px]:gap-[20px]">
        {/* Left Arrow - Desktop Only */}
        <span
          className="w-[60px] h-[60px] flex items-center justify-center bg-[#19383b] cursor-pointer rounded-[50px] mx-6 max-[440px]:hidden"
          onClick={showPrev}
        >
          <svg xmlns="http://www.w3.org/2000/svg" width="10" height="20" viewBox="0 0 14 24" fill="none">
            <path
              d="M3.40564 11.8584L12.5915 21.0442C12.904 21.3567 13.0552 21.7212 13.0452 22.1378C13.0352 22.5544 12.8735 22.9189 12.5603 23.2313C12.247 23.5438 11.8825 23.7 11.4667 23.7C11.051 23.7 10.6864 23.5438 10.3732 23.2313L0.749866 13.6393C0.499911 13.3893 0.312444 13.1081 0.187467 12.7957C0.0624889 12.4832 0 12.1708 0 11.8584C0 11.5459 0.0624889 11.2335 0.187467 10.921C0.312444 10.6086 0.499911 10.3274 0.749866 10.0774L10.3732 0.454134C10.6856 0.14169 11.0555 -0.00953319 11.483 0.000465034C11.9104 0.0104633 12.2799 0.172101 12.5915 0.485379C12.9031 0.798656 13.0593 1.16317 13.0602 1.57893C13.061 1.99469 12.9048 2.35921 12.5915 2.67249L3.40564 11.8584Z"
              fill="white"
            />
        ...
        {/* Image Slider */}
        <div className="h-auto flex-1 max-w-[800px] aspect-video overflow-hidden w-fit rounded-[15px]
  max-[440px]:w-[310px] max-[440px]:h-[178px] max-[440px]:mx-auto">
          ...
          >
            {[0, 1, 2].map((i) => (
              <div key={i} className="min-w-full">
                <DraggableImages
                  imageRight={[dragImg1_1, dragImg2_1, dragImg3_1][i]}
                  imageLeft={[dragImg1_2, dragImg2_2, dragImg3_2][i]}
                />
              </div>
            ))}
          </div>
        ...
        {/* Right Arrow */}
        <span
          className="w-[60px] h-[60px] flex items-center justify-center bg-[#19383b] cursor-pointer rounded-[50px] mx-4 max-[440px]:mt-[10px] max-[440px]:w-[30px] max-[440px]:h-[30px]"
          onClick={showNext}
        >
          <svg xmlns="http://www.w3.org/2000/svg" width="10" height="20" viewBox="0 0 14 24" fill="none">
            <path
      ...
      <div className="flex justify-center items-center mt-10 gap-[14px] my-5">
        {[0, 1, 2].map((i) => (
          <span
            key={i}
            onClick={() => setIndex(i)}
            className={`w-[12px] h-[12px] rounded-full cursor-pointer transition-all duration-200 ${index === i
                ? "bg-[#00B0BA]"
                : "bg-white border border-[#D0D0D0] max-[440px]:w-2 max-[440px]:h-2"
              }`}
          />
        ))}
      </div>
